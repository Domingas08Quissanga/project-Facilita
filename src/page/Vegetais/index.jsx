...
import imgUrl from '../../assets/Vegetais.jpeg'
import {Footer} from '../../components/Footer/Footer'
import { ImageCards } from '../../components/Cards/cardVegetais'
import { PriceFormat } from '../../utils/numberFormat'
import VegetaisDesc from '../../assets/vegetalbanner.png'
...
export function Vegetais() {
    const divStyle = {
      ...
      return (
        <C.Container>
            <div style={divStyle}>
           <h2><span>Legumes</span> da nossa terra</h2> 
           </div>
           <C.bannerProduct>
            <img src={VegetaisDesc} alt="" />
          <div>
